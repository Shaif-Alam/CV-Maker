...
const AboutUs = () => {
    return (
        <div className="page-wrapper">
            ...
            <main style={{ backgroundColor: 'var(--theme-bg)', minHeight: '100vh', paddingBottom: '5rem' }}>
                {/* Green Header Ribbon */}
                <div style={{
                ...
                <div style={{
                    ...
                    <h2 style={{ fontSize: '1.5rem', color: 'var(--theme-text)', marginBottom: '1rem', fontWeight: 'bold' }}>
                        About CVMaker
                    </h2>
                    <p style={{ color: 'var(--theme-text-muted)', lineHeight: '1.7', marginBottom: '1.5rem' }}>
                    ...
                    <p style={{ color: 'var(--theme-text-muted)', lineHeight: '1.7', marginBottom: '2rem' }}>
                    ...
                    <h2 style={{ fontSize: '1.25rem', color: 'var(--theme-text)', marginBottom: '1rem', fontWeight: 'bold' }}>
                        We are Successful!
                    </h2>
                    <p style={{ color: 'var(--theme-text-muted)', lineHeight: '1.7', marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--theme-text-muted)', lineHeight: '1.7', marginBottom: '1rem' }}>
                    ...
                    <div style={{ color: 'var(--theme-text-muted)', lineHeight: '1.6' }}>
                        <p>CVmaker BV</p>
